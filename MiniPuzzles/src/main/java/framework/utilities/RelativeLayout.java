 ...
 *
 * Components can be laid out at their preferred size or at a relative size.
 ...
 *
 * By defaults components are centre aligned on the secondary axis however this
 * can be changed at the container or component level.
 *
 * See
 * <a href="https://tips4java.wordpress.com/2008/11/02/relative-layout/">Relative
 * Layout</a>
 *
 * author: Rob Camick
 */
public class RelativeLayout implements LayoutManager2, java.io.Serializable {
    ...
    /**
     * Specify the rounding policy to be used when all the available pixels have
